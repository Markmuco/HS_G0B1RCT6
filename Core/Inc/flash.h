...
#define FLASH_APP_START_ADDR		ADDR_FLASH_PAGE_8 // at 16kb
#define FLASH_APP_END_ADDR			ADDR_FLASH_PAGE_126	// 16kb + 106Kb

#define APP_SIZE					(FLASH_APP_END_ADDR - FLASH_APP_START_ADDR) // Kb

#define FLASH_EE_START_ADDR			ADDR_FLASH_PAGE_126   /* Start @ of user Flash area */
#define FLASH_EE_COPY_START_ADDR	ADDR_FLASH_PAGE_127  /* Start @ of user Flash area */

#define FLASH_EE_SIZE				FLASH_PAGE_SIZE



/* Base address of the Flash sectors */
// code uit STM32Cube_FW_F1_V1.6.1\Projects\STM3210E_EVAL\Applications\IAP\IAP_Main\Inc
/* Base address of the Flash sectors */
...
#define ADDR_FLASH_PAGE_END   ((uint32_t)0x08040000) /* Base @ of Page END */
